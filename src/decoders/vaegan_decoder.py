...
def vaegan_decoder(z, args, reuse=False):
    ...
    with tf.variable_scope("decoder", reuse=reuse):
        ...
        unflattened = tf.reshape(relu_fc,
                                     shape=(args.batch_size, reshape_height, reshape_width, num_last_conv_filters))
        ...
        deconv1 = tf.layers.conv2d_transpose(inputs=unflattened,
                       filters=256,
                       kernel_size=5,
                       strides=2,
                       padding=padding,
