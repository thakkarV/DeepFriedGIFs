...
def parse_train_args():
    parser = argparse.ArgumentParser(
        description="Argument praser for codec training.")
...
def parse_compress_args():
    parser = argparse.ArgumentParser(
        description="Argument praser for GIF compression.")
    parser = add_common_args(parser)
    parser.add_argument(
        "-e", "--encoder",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="Name of the output compressed file."
    )
...
def parse_decompress_args():
    parser = argparse.ArgumentParser(
        description="Argument praser for GIF decompression.")
    parser = add_common_args(parser)
    parser.add_argument(
        "-d", "--decoder",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="Name of the output decompressed file."
    )
